let ITENS_LOJA = [
  {
    ...
    descricao:
      "Bola utilizada na Copa do Mundo, idela para utilizar em campo e colecionar",
  },
  {
  ...
  },
  {
    ...
    descricao:
      "Utilizada em batalhar para neutralizar o inimigo ou como item de decoração",
  },
  {
    nome: "Guitarra",
    preco: 1980.99,
...
function criar_item(url_img, nome, preco, descricao) {
  return `
        <div class="item">
        <img src="${url_img}" />
        <h1>${nome}</h1>
        ...
        <br />
        <p> <span>Descrição:</span> <br /> ${descricao} </p>
        </div>
    `;
}
...
document.querySelector("#itens_section").innerHTML =
  criar_item(
    ITENS_LOJA[0].url_img,
    ITENS_LOJA[0].nome,
    ITENS_LOJA[0].preco,
    ITENS_LOJA[0].descricao
  ) +
  criar_item(
    ITENS_LOJA[1].url_img,
    ITENS_LOJA[1].nome,
    ITENS_LOJA[1].preco,
    ITENS_LOJA[1].descricao
  ) +
  criar_item(
    ITENS_LOJA[2].url_img,
    ITENS_LOJA[2].nome,
    ITENS_LOJA[2].preco,
    ITENS_LOJA[2].descricao
  ) +
  criar_item(
    ITENS_LOJA[3].url_img,
    ITENS_LOJA[3].nome,
    ITENS_LOJA[3].preco,
    ITENS_LOJA[3].descricao
  ) +
  criar_item(
    ITENS_LOJA[4].url_img,
    ITENS_LOJA[4].nome,
    ITENS_LOJA[4].preco,
    ITENS_LOJA[4].descricao
  ) +
  criar_item(
    ITENS_LOJA[5].url_img,
    ITENS_LOJA[5].nome,
    ITENS_LOJA[5].preco,
    ITENS_LOJA[5].descricao
  ) +
  criar_item(
    ITENS_LOJA[6].url_img,
    ITENS_LOJA[6].nome,
    ITENS_LOJA[6].preco,
    ITENS_LOJA[6].descricao
  ) +
  criar_item(
    ITENS_LOJA[7].url_img,
    ITENS_LOJA[7].nome,
    ITENS_LOJA[7].preco,
    ITENS_LOJA[7].descricao
  );
